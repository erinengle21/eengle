...
<html>
    <head>
        <title> Lab 7: Admin Log in</title>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="loginForm" id="login-submit" tabindex="4" class="form-control btn btn-login" value="Log In">
											</div>
										</div>
									</div>
									<div class="form-group">
								...
								<form id="register-form" action="loginProcess.php" method="post" role="form" style="display: none;">
									<div class="form-group">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="loginForm" id="register-submit" tabindex="4" class="form-control btn btn-register" value="Admin Login">
											</div>
										</div>
									</div>
								</form>
